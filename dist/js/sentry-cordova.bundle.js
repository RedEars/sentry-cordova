...
// tslint:disable:strict-type-predicates
function getGlobalObject() {
    return isNodeEnv() ? commonjsGlobal$$1 : typeof window !== 'undefined' ? window : typeof self !== 'undefined' ? self : {};
}
exports.getGlobalObject = getGlobalObject;
/**
 * UUID4 generator
...
var BaseTransport = /** @class */ (function () {
    ...
    BaseTransport.prototype.captureEvent = function (_) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                throw new dist$3.SentryError('Transport Class has to implement `captureEvent` method');
            });
        });
    };
        ...
        try {
            ...
            dist$3.withScope(function (scope) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                ...
                return tslib_1.__generator(this, function (_a) {
                    ...
                    dist$3.getCurrentHub().captureException(ex, { originalException: ex });
                    return [2 /*return*/];
                });
            }); });
            throw ex;
        ...
        this.Ember.onerror = function (error) {
            if (dist$3.getCurrentHub().getIntegration(Ember)) {
                dist$3.withScope(function (scope) {
                    ...
                    dist$3.getCurrentHub().captureException(error, { originalException: error });
                });
            }
            ...
            if (dist$3.getCurrentHub().getIntegration(Ember)) {
                dist$3.withScope(function (scope) {
                    if (reason instanceof Error) {
                        ...
                        _this.addIntegrationToSdkInfo(scope);
                        dist$3.getCurrentHub().captureException(reason, { originalException: reason });
                    }
                    else {
...
var dist_21 = dist_3$3.defaultIntegrations;
...
function init(options) {
    if (options.defaultIntegrations === undefined) {
        options.defaultIntegrations = __spread(dist_21, [new Cordova(), new Release()]);
    }
